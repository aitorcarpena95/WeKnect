...
class User_model extends CI_Model {
	...
	private function send_confirmation_email($username, $email) {
		...
		$this->email->to($email);
		$this->email->subject('Porfavor confirma tu email para validar la cuenta de usuario.');
		...
		$message .= "Hola " . $username . ", gracias por registrarte! <br><br>";
		//$message .= "Porfavor pulsa el siguiente link para confirmar tu cuenta en " . base_url(knect.asir6.enganxat.net) . "<br><br>";
                $message .= "Porfavor pulsa el siguiente link para confirmar tu cuenta en https://knect.asir6.enganxat.net"."<br><br>";
		$message .= " <a href=\"" . "https://knect.asir6.enganxat.net/index.php/user/email_validation/" . $username . "/" . $hash . "\">Confirmar tu email y validar la cuenta</a>";
		$message .= "</body></html>";
